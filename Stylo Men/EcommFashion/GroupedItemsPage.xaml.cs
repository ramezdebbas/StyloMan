...
namespace EcommFashion
{
    ...
    /// </summary>
    public sealed partial class GroupedItemsPage : EcommFashion.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            EnableLiveTile.CreateLiveTile.ShowliveTile(true, "Stylo Men");
        }
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(ItemDetail), e.ClickedItem);
        }
